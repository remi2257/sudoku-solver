...
def show_big_image(frame_resize, prepro_im, img_lines, img_contour, use_hough=False):
    if not use_hough:
        ...
        (text_width, text_height) = cv2.getTextSize(text1, font_base, fontScale=font_scale_normal, thickness=thickness_normal)[0]
        ...
        cv2.putText(im_res, text1,
                    (10, text_height + 10),
                    font_base, font_scale_normal, RED, thickness_normal)

        (text_width, text_height) = cv2.getTextSize(text2, font_base, fontScale=font_scale_normal, thickness=thickness_normal)[0]
        ...
        (text_width, text_height) = cv2.getTextSize(text3, font_base, fontScale=font_scale_normal, thickness=thickness_normal)[0]
        ...
        (text_width, text_height) = cv2.getTextSize(text4, font_base, fontScale=font_scale_normal, thickness=thickness_normal)[0]

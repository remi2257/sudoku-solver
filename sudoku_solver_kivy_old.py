...
class SolverScreen(Screen):
    btn_solve_unfreeze = ObjectProperty(None)

    btn_full_solve = ObjectProperty(None)
    btn_hint = ObjectProperty(None)
...
class LiveSolverScreen(SolverScreen):
    ...
    def act_button(self):
        if self.btn_solve_unfreeze.text == "Solve":
            self.solve()
            self.btn_solve_unfreeze.text = "Unfreeze"
        else:
            self.camera.unfreeze()
            self.btn_solve_unfreeze.text = "Solve"
